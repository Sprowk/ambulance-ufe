...
import { Cv3amAmbulanceWlEditor } from '../cv3am-ambulance-wl-editor';
...
describe('cv3am-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [Cv3amAmbulanceWlEditor],
      html: `<cv3am-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></cv3am-ambulance-wl-editor>`,
    });
